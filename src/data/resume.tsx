...
export const DATA = {
  ...
  contact: {
    ...
    social: {
      ...
      email: {
        name: "Send Email",
        url: "mailto:orminamadro@gmail.com",
        icon: Icons.email,
  ...
  education: [
    {
      school: "Antonio Jose Camacho University",
      href: "https://www.uniajc.edu.co/",
  ...
  projects: [
    ...
    },
    {
      ...
      active: false,
      description:
        "A fan-made website dedicated to the talented artist Scarlxrd, a British rapper, singer, and composer. This web platform showcases his latest YouTube videos and albums.",
      technologies: [
        "Next.js",
        "Typescript",
        "TailwindCSS",
